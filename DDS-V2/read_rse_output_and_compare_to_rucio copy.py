...
import datetime
from transforming_to_database_from_txt import transforming_to_database_from_txt, comparison, missing_from_storage, create_table_missing_from_storage
...
def main():
    ...
    for rse in os.listdir("RSE"):
        ...
        if os.path.isdir("RSE/"+rse+"/output"):
            ...
            database_missing_from_storage = sl.connect("RSE/"+rse+"/Dark_data/this_cycle/"+'storage_output.db')
